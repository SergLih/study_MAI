...
//здесь все реализованы автоматы, кроме трех последних
...
string tBaseLexer::GetToken(){ //возвращает символ токена
  lexeme = "";
...
// строка
  if(*start == '"'){ //означает, что обнаружил ", его учитывать не надо.
   ...
   //конечные автоматы дольше работают чем линейное сканирование
   //атом должен быть допущен целиком, а не частично
   //2 операции:
   //выделение токена из потока
   //распознание токена из ... второго уровня
   //ранжирование
