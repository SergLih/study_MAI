...
<body>
<h1>Спортивные объекты Москвы</h1>
<h3>Уникальные атрибуты в исходном XML-документе, количество: <xsl:value-of select="count(//@*[count(.|key('elements', local-name())[1]) = 1])"/></h3>
<ol>
